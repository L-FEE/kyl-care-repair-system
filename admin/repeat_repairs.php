...
<div class="card p-3 mb-4 shadow-sm border-0 rounded-4">
    <form method="GET" class="row gx-2 gy-2 align-items-end" id="filterForm">
        ...
        <div class="col-md-auto ms-auto d-flex gap-2">
            <!-- ปุ่มรีเซ็ตไอคอน -->
            <a href="<?= BASE_URL ?>/admin/repeat_repairs.php?tab=<?= $current_tab ?>" class="btn btn-sm btn-outline-secondary px-3 rounded-3" title="รีเซ็ต" style="height: 31px; display: flex; align-items: center;">
